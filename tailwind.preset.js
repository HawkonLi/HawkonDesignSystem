...
module.exports = {
  theme: {
    extend: {
      ...
      boxShadow: {
        'e1':'0 1px 2px rgba(18,31,48,.06), 0 1px 3px rgba(18,31,48,.10)',
        'e2':'0 1px 2px rgba(18,31,48,.06), 0 2px 6px rgba(18,31,48,.08)',
        'e3':'0 2px 6px rgba(18,31,48,.08), 0 8px 24px rgba(18,31,48,.12)',
        'e4':'0 4px 12px rgba(18,31,48,.10), 0 16px 40px rgba(18,31,48,.18)',
      },
    },
  },
};
